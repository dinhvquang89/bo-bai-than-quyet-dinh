...
## 1. Tổng quan Lưu lượng (Traffic)
| Variant | Tổng User (Unique IDs) | Ghi chú |
| :--- | :--- | :--- |
| **A (Lenormand)** | 0 | Đang chờ dữ liệu... |
| **B (AI Oracle)** | 0 | Đang chờ dữ liệu... |

## 2. Hiệu quả Lan truyền (Metric 2: Share Rate)
*Công thức: (Số lần bấm Share / Tổng User)*

| Variant | Lượt Share | Tỷ lệ Chuyển đổi | Đánh giá |
| :--- | :--- | :--- | :--- |
| **A (Lenormand)** | 0 | 0% | -- |
| **B (AI Oracle)** | 0 | 0% | -- |

## 3. Tỷ lệ Giữ chân (Metric 3: Retention Rate)
*Công thức: Số User quay lại ngày tiếp theo / Tổng User ban đầu*

| Variant | Ngày 1 (D1) | Ngày 3 (D3) | Kết luận |
| :--- | :--- | :--- | :--- |
| **A (Lenormand)** | 0% | 0% | -- |
| **B (AI Oracle)** | 0% | 0% | -- |
