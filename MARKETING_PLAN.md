...
### 📌 Kênh 1: TikTok (Kênh Mũi Nhọn - Hero Channel)
...
*Nơi tập trung vào yếu tố visual cực đẹp của website (UI/UX).*

- **Concept nội dung:**
  - **Reels:** Đăng lại các video từ TikTok nhưng có tính aesthetic cao hơn (chỉnh màu, nhạc lofi/chill).
  - **Carousel/Post:** Hình ảnh các lá bài đẹp nhất trong bộ bài kèm trích dẫn (quote) ý nghĩa hoặc thông điệp trong ngày.
  - **Stories:** Tương tác "Pick a Card" bằng cách dùng tính năng poll/quiz của IG, sau đó dẫn link qua website để xem kết quả.
- **Hành động:**
  - Thiết kế feed mang tone màu huyền bí, vũ trụ (Dark mode, gradient).
  - Tích hợp Affiliate: Nhắc đến các vật phẩm phong thủy, may mắn (Lucky Charms) trên Stories.

### 📌 Kênh 3: Facebook (Cộng Đồng & Seeding)
